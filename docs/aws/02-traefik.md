...
flowchart TB
    ...
    R53["Route53<br/>vijaygiduthuri.in<br/>ALIAS to the NLB"]
...
> pointing at `https://vijaygiduthuri.in` — a name that does not
...
4. create a Route53 **ALIAS** record for `vijaygiduthuri.in` pointing at it
...
> from the **zone apex** (`vijaygiduthuri.in`, no subdomain), and **a CNAME is
...
>   --query "ResourceRecordSets[?Name=='vijaygiduthuri.in.'].[Type]" --output text
> # A
> # NS
> # SOA
> ```
